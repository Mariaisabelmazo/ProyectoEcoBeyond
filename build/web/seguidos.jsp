...
<html>
    ...
    <section class="header2">
        <div class="menu-perfil">
            ...
            <a href="recomendaciones.jsp" title="">Recomendaciones</a>
    ...
    <section class="seguidores">
        <div class="seg">
            ...
            <div class="seguidor">
                ...
                <div class="contenido-texto-card">
                    <h4>Eco-Influencer 2</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit repellendus ex culpa natus temporibus.</p>
                </div>
            </div>
        </div>
    </section>
